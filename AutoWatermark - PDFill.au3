...
Global $Form1_1 = GUICreate("Form1",  862, 188, 725, 155)
Global $txt1 = GUICtrlCreateInput("",  80, 88, 585, 22)
Global $Watermark = GUICtrlCreateLabel("Watermark",  16, 88, 56, 18)
Global $Footer = GUICtrlCreateLabel("Footer",32, 59, 35, 18)
Global $txt2 = GUICtrlCreateInput("",80, 59, 585, 22)

Global $Enable1 = GUICtrlCreateCheckbox("Watermark", 408, 24, 73, 17)
GUICtrlSetState(-1, $GUI_CHECKED)
Global $Enable = GUICtrlCreateCheckbox("Footer", 344, 24, 49, 17)
GUICtrlSetState(-1, $GUI_CHECKED)
Global $Label1 = GUICtrlCreateLabel("AUTOMATED WATERMARKING FROM PDFill", 336, 0, 240, 25)
Global $Button2 = GUICtrlCreateButton("3 - Enter", 680, 56, 155, 97)
Global $txt3 = GUICtrlCreateInput("", 80, 136, 313, 22)
Global $txt4 = GUICtrlCreateInput("",424, 136, 233, 22)
Global $Label2 = GUICtrlCreateLabel("From", 24, 144, 56, 18)
Global $Label3 = GUICtrlCreateLabel("To", 400, 136, 24, 18)
Global $Label4 = GUICtrlCreateLabel("Split pages from PDF using PDFill", 368, 112, 208, 18)
Global $Enable2 = GUICtrlCreateCheckbox("Split pages", 496, 24, 73, 17)
GUICtrlSetState(-1, $GUI_CHECKED)
Global $Browse = GUICtrlCreateButton("2 - Browse", 752, 16, 75, 25)
Global $Button1 = GUICtrlCreateButton("1 - Select PDFill ", 88, 8, 139, 33)
GUISetState(@SW_SHOW)
...
While 1
	...
	Switch $nMsg
		Case $GUI_EVENT_CLOSE
			Exit
		Case $Browse
			Global $FileSelected = FileOpenDialog  ("Hold down Ctrl or Shift to choose multiple files", @WindowsDir & "\", "All (*.*)", $FD_FILEMUSTEXIST)
			If @error Then
		...
		Case $Button1
			Global $PDfillSelected = FileOpenDialog  ("Select PDF fill shortcut or path", @WindowsDir & "\", "All (*.*)", $FD_FILEMUSTEXIST)
			If @error Then
                MsgBox(4096, "", "No File(s) chosen")
            Else
                $PDfillSelected = StringReplace($PDfillSelected, "|", @CRLF)
                MsgBox(4096, "", "You have selected" & $PDfillSelected)
            EndIf
